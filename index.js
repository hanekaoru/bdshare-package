(function (global, factory) {
  ...
  var cmdList = ['qzone', 'weixin', 'tsina', 'baidu', 'renren', 'tqq', 'kaixin001', 'tqf', 'hi', 'douban', 'tsohu', 'msn', 'sqq', 'thx', 'taobao', 'tieba', 'buzz', 'sohu', 't163', 'qy', 'meilishuo', 'mogujie', 'diandian', 'huaban', 'leho', 'share189', 'duitang', 'hx', 'tfh', 'fx', 'tuita', 'ff', 'wealink', 'youdao', 'xg', 'ty', 'fbook', 'twi', 'ms', 'deli', 's139', 's51', 'zx', 'linkedin', 'copy'];
  ...
  function loadBdshare () {
      window._bd_share_main ? window._bd_share_is_recently_loaded = !0 : (window._bd_share_is_recently_loaded = !1, window._bd_share_main = {
          ...
          jscfg: {
              domain: {
                  staticUrl: location.protocol === "https:" ? "https://ss1.baidu.com/9rA4cT8aBw9FktbgoI7O1ygwehsv/" : "http://bdimg.share.baidu.com/"
              }
          }
              ...
              e.onload = e.onerror = e.onreadystatechange = function () {
                  if (/loaded|complete|undefined/.test(e.readyState)) {
                      ...
                      if (e.parentNode) {
                          ...
                          try {
                              if (e.clearAttributes) e.clearAttributes();else for (var n in e) {
                                  delete e[n];
                              }
                          } catch (r) {}
                      }
          ...
          var s = {
              ...
              _paths: {},
              _rules: [],
              addPathRule: function addPathRule(e) {
                  this._rules.push(e);
              }
          };
          ...
          e._setMod = function (e) {
              ...
              if ((typeof t === "undefined" ? "undefined" : _typeof(t)) == "object") r(t, function (t, n) {
                  e._fileMap(n, t);
              });else {
                  var s = c;
              ...
              (typeof e === "undefined" ? "undefined" : _typeof(e)) == "object" && r(e, function (e, t) {
  ...
  var $share = document$1.createElement('div');
  $share.style.display = 'none';
  $share.className = 'bdsharebuttonbox';
  for (var i = 0; i < cmdList.length; i++) {
      ~function (i) {
          var $item = document$1.createElement('a');
  ...
  document$1.body.appendChild($share);
